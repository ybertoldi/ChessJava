public class Board {
    ...
    public void resetBoard(){
        ...
        boxes[1][7] = new  Spot(new Knight(true), 1, 7);
        boxes[2][7] = new  Spot(new Bishop(true), 2, 7);
        boxes[3][7] = new  Spot(new Queen(true), 3, 7);
        boxes[4][7] = new  Spot(new King(true), 4, 7);
        boxes[5][7] = new  Spot(new Bishop(true), 5, 7);
        boxes[6][7] = new  Spot(new Knight(true), 6, 7);
